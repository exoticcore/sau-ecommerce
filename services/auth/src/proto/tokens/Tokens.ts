...
export interface TokensClient extends grpc.Client {
  verify(argument: _tokens_AccessToken, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_tokens_TokenInfo__Output>): grpc.ClientUnaryCall;
